   ...
   public class LessonPlan
    {
        ...
        private ICollection<WebsiteUser> _websiteUserLessonPlanLike;
        public ICollection<WebsiteUser> WebsiteUserLessonPlanLike
        {
            get { return _websiteUserLessonPlanLike ?? (_websiteUserLessonPlanLike = new List<WebsiteUser>()); }
            set { _websiteUserLessonPlanLike = value; }
        }
